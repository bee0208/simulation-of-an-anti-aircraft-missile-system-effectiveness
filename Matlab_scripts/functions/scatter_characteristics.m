...
xlabel('h_\beta')
ylabel('h_\epsilon')
legend('Target','Spread center [m_\beta, m_\epsilon]','Elipse_1 [\sigma_\beta, \sigma_\epsilon]',...
'Elipse_2 [2\sigma_\beta, 2\sigma_\epsilon]','Elipse_3 [3\sigma_\beta, 3\sigma_\epsilon]','Location','northeastoutside')
title('Spread characteristics')
ax = gca;
